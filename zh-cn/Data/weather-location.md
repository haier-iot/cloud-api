...
|conditionId|icon（白天）|icon（夜间）|condition|
|:-----:|:-----:|:-----:|:-----:|
|1|0|30|晴|
|2|0|30|晴|
|3|0|30|晴|
...
> 由于新的天气服务供应商未提供天气现象和conditionId的对应关系，因此天气服务不再提供和维护旧的关系，下面是icon和condition的对应关系。
